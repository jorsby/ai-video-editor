...
const episodeRoutes: ApiRouteDefinition[] = [
      ...
      episodes: [
        {
          ...
          asset_variant_map: {
            characters: ['ali-default'],
            locations: ['medina-courtyard-default'],
            props: ['seal-ring-default'],
          },
          plan_json: null,
          status: 'draft',
          created_at: '2026-03-31T00:00:00Z',
  ...
  },
  {
    ...
    body: {
      ...
      order: 1500,
      asset_variant_map: {
        characters: ['ali-default', 'fatima-night'],
        locations: ['medina-courtyard-default'],
        props: [],
      },
    },
...
const variantRoutes: ApiRouteDefinition[] = [
  ...
  },
  {
    ...
    auth: 'session-or-api-key',
    description:
      "Creates one or more variants for an asset. Accepts a single object or an array. If is_default=true, resets all other variants' default flag.",
    pathParams: { assetId: 'asset-uuid' },
    body: {
      name: 'Night Variant',
      slug: 'ali-night',
  ...
  },
  {
    ...
    auth: 'session-or-api-key',
    description:
      'Updates a variant. Supports: name, slug, prompt, image_url, is_default, where_to_use, reasoning. Setting is_default=true resets others.',
...
const sceneRoutes: ApiRouteDefinition[] = [
      ...
      scenes: [
        {
          ...
          location_variant_slug: 'medina-courtyard-default',
          character_variant_slugs: ['ali-default'],
          prop_variant_slugs: ['seal-ring-default'],
          audio_text:
    ...
    body: {
      scenes: [
        ...
        },
        {
          ...
          location_variant_slug: 'medina-courtyard-default',
          character_variant_slugs: ['ali-default', 'fatima-default'],
          prop_variant_slugs: [],
          audio_text:
  ...
  },
  {
    ...
    body: {
      ...
      location_variant_slug: 'desert-road-default',
      character_variant_slugs: ['ali-night', 'fatima-default'],
      prop_variant_slugs: ['seal-ring-default'],
