...
export const GRID_RESOLUTION_OPTIONS = [
  ...
  { value: '1_5k', label: '1.5K (1536)' },
  { value: '2k', label: '2K (2048)' },
  { value: '3k', label: '3K (3072)' },
...
const GRID_RESOLUTION_LONG_SIDE: Record<GridResolution, number> = {
  '1k': 1024,
  '1_5k': 1536,
  '2k': 2048,
  '3k': 3072,
...
export function getGridOutputDimensions(
  ...
  const longSide = GRID_RESOLUTION_LONG_SIDE[resolution];
