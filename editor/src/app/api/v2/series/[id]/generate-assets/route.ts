...
const PREFIX_BY_ASSET_TYPE: Record<string, string> = {
  character: 'Front-facing portrait, full body visible, neutral background. ',
  location: 'Empty environment, no people. ',
  prop: 'Product shot on clean background. ',
};
...
export async function POST(req: NextRequest, context: RouteContext) {
  try {
    ...
    for (const asset of assetsWithoutImages) {
      ...
      const size = RESOLUTION_TO_SIZE[resolution];
