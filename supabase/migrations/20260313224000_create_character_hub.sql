...
-- characters policies (direct user_id ownership)
...
-- -----------------------------------------------------------------------------
DROP POLICY IF EXISTS characters_service_all ON studio.characters;
CREATE POLICY characters_service_all
ON studio.characters
FOR ALL
TO service_role
USING (true)
...
DROP POLICY IF EXISTS character_images_service_all ON studio.character_images;
CREATE POLICY character_images_service_all
ON studio.character_images
FOR ALL
TO service_role
USING (true)
...
DROP POLICY IF EXISTS project_characters_service_all ON studio.project_characters;
CREATE POLICY project_characters_service_all
ON studio.project_characters
FOR ALL
TO service_role
USING (true)
...
-- -----------------------------------------------------------------------------
-- Storage: private bucket for character assets
-- -----------------------------------------------------------------------------
INSERT INTO storage.buckets (id, name, public)
VALUES ('character-assets', 'character-assets', false)
ON CONFLICT (id) DO NOTHING;

-- Storage policies: user can manage their own folder
...
-- Service role full access to character-assets bucket
DROP POLICY IF EXISTS character_assets_service_all ON storage.objects;
CREATE POLICY character_assets_service_all
ON storage.objects
FOR ALL
TO service_role
